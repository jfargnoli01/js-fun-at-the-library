...
if(pages < 1000) {
  ...
  'Ok, maybe I could that in a day and a half';
};
...
var books = ["Farenheit 451", "Harry Potter and the Goblet of Fire", "Jane Eyre", "Lakota Woman", "Catcher in the Rye"];
...
var belowTwoHundred = [15, 21, 32, 44, 5, 67, 78, 89, 90, 100, 111, 124];
